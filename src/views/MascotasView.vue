...
<template>
  <div class="titulo"><h1>Mascotas</h1></div>
  ...
  <div class="filtro" v-if="filtersVisible">
    <button @click="filterProducts('guantes quita pelo')">
      guantes quita pelo
    </button>
    <button @click="filterProducts('comederos')">comederos</button>
