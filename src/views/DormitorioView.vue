...
<template>
  <div class="titulo"><h1>dormitorio</h1></div>
  ...
  <div class="filtro" v-if="filtersVisible">
    ...
    <button @click="filterProducts('base camas')">base camas</button>
    <button @click="filterProducts('juego de sabanas')">
      juego de sabanas
    </button>
    <button @click="filterProducts('colchones + base camas')">
      colchones + basecamas
    </button>
